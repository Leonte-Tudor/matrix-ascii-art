...
fn fill_indicators(m: &mut Vec<i32>, c: usize, c2: usize, l: usize, l2: usize, flag_mode: bool) {
    for i in 1..l2 / 2 {
...
fn draw_matrix(m: &mut Vec<i32>, c: usize, c2: usize, l: usize, l2: usize, size: usize, ind: usize, flag_mode: bool, par: bool) {
    for i in 0..size {
        if i % c as usize == 0 {
            print!("{:ind$}", "");
        }
        ...
        match m[i] {
            ...
            { print!("{} ", "⤩".white().dimmed()); } else { print!("{} ", "↙".white().dimmed()); },
...
fn main() {
    ...
    fill_indicators(&mut m, c, c2, l, l2, flag_mode);
    ...
    draw_matrix(&mut m, c, c2, l, l2, size, ind, flag_mode, par);
